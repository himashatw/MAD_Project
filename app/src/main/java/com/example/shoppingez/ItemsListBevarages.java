...
public class ItemsListBevarages extends AppCompatActivity implements ImageAdapter1.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_items_list_bevarages);
        ...
        mAdapter = new ImageAdapter1(ItemsListBevarages.this, mUploads);

        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(ItemsListBevarages.this);
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if ((items.getItemCategory().equals("Beverages")) ||(items.getItemCategory().equals("beverages")) ){
                        mUploads.add(items);
                    }
