...
public class ItemsListRice extends AppCompatActivity implements ImageAdapter1.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_items_list_rice);
        ...
        mAdapter = new ImageAdapter1(ItemsListRice.this, mUploads);

        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(ItemsListRice.this);
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if ((items.getItemCategory().equals("Rice")) ||(items.getItemCategory().equals("rice")) ){
                        mUploads.add(items);
                    }
